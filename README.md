...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-tag.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-tag)
...
```bash
php artisan vendor:publish --tag="laravel-tag-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-tag-views"
```

## Usage

```php
$tag = new Foodieneers\Tag();
echo $tag->echoPhrase('Hello, Foodieneers!');
```
